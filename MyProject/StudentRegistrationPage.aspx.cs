    ...
    public partial class Homepage : System.Web.UI.Page
    {
        ...
        bool checkMemberExists()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from StudentRegistrationDetails where UserID='"+TextBox8.Text.Trim()+"';", con);
        ...
        void signUpNewUser()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO StudentRegistrationDetails(FullName,DOB,ContactNo,EmailID,State,Degree,AadharNo,City,Pincode,UserID,Password) values(@FullName,@DOB,@ContactNo,@EmailID,@State,@Degree,@AadharNo,@City,@Pincode,@UserID,@Password)", con);
